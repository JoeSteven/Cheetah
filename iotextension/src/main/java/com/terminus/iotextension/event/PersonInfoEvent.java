...
public class PersonInfoEvent extends BaseEvent{
    ...
    //更新的人员信息列表
    public final List<TSLIOTDataSync.TSLIOTPersonItem> items;

    public PersonInfoEvent(String devId, long version, int more, List<TSLIOTDataSync.TSLIOTPersonItem> items) {
        this.devId = devId;
