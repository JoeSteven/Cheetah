...
public class IotFrame {
    ...
    public byte[] toByteWithoutCrc(){
        ...
        if(MsgType == IoTProtocol.MSG_TYPE_SYSTEM && ServiceType == IoTProtocol.SERVICE_TYPE_ACCESS && Cmd == IoTProtocol.CMD_TYPE_WILL){

        }else if(MsgType == IoTProtocol.MSG_TYPE_SYSTEM && ServiceType == IoTProtocol.SERVICE_TYPE_ACCESS && Cmd == IoTProtocol.CMD_TYPE_UPDATE_AESKEY){
